...
# DOCKER-VERSION        1
FROM    debian:wheezy
MAINTAINER Andrew Hao <andrewhao@gmail.com>
...
# If Drupal isn't installed yet...
# RUN cd /var ; drush dl drupal ; mv /var/drupal*/ /var/www/

# Moving this to start.sh
#ADD . /var/www
#RUN chmod a+w /var/www/sites/default ; mkdir -p /var/www/sites/default/files ; chown -R www-data:www-data /var/www/

# TODO how are we going to load the settings.php?
